...
import { scienceLevels, type MCQ } from '@/lib/science-questions';
import {
  Card,
  CardContent,
  CardDescription,
...
export default function ScienceLevelPage() {
  ...
  const level = scienceLevels.find((l) => l.level === levelNumber);
  ...
  if (!level) {
    return (
      <div className="text-center py-10">
        ...
        <Button onClick={() => router.push('/science/levels')} className="mt-4">
          Back to Levels
        </Button>
      </div>
    );
  ...
  const handleQuizCompletion = () => {
    ...
    const moduleId = `science-${level.level}`;
            ...
            <Card className="bg-secondary">
                ...
                <CardFooter className="flex-col gap-4">
                    ...
                    <Button asChild variant="outline" className="w-full">
                       <Link href="/science/levels">Back to Levels</Link>
                    </Button>
                </CardFooter>
            </Card>
        </div>
