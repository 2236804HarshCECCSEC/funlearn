...
import { FlaskConical, Gamepad2, School } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto max-w-2xl py-8">
       <div className="flex flex-col items-center text-center mb-8">
        ...
        <h1 className="text-4xl font-bold font-headline">Science Quests</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Test your knowledge with our fun science challenges.</CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4">
            <Link href="/science/levels" className="block p-6 bg-secondary/80 rounded-lg hover:bg-secondary transition-colors">
